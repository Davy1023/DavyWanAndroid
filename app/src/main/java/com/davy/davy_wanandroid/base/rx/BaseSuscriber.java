 ...
 * date: 2018/9/26
 */
public abstract class BaseSuscriber<T> extends ResourceSubscriber<T> {
    private AbstractView mView;
    private String mErrorMsg;
    private boolean isShowError = true;

    public BaseSuscriber(AbstractView view){
        this.mView = view;
    }

    public BaseSuscriber(AbstractView view, String msg){
        this.mView = view;
        this.mErrorMsg = msg;
    }

    public BaseSuscriber(AbstractView view, boolean isShow){
        this.mView = view;
        this.isShowError = isShow;
    }

    public BaseSuscriber(AbstractView view, String msg, boolean isShow){
        this.mView = view;
        this.mErrorMsg = msg;
        this.isShowError = isShow;
    }
